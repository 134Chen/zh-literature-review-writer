...
一个面向中文学术写作的 Codex skill，用于检索、筛选、梳理和辅助撰写文献综述、研究现状与 related work。

## 免责声明

- 本项目仅可用于帮助用户了解某一研究方向的研究现状、整理文献线索和形成写作思路。
- 本项目生成的内容不能直接作为学位论文、学术论文或其他正式学术材料的提交稿件使用。
- 用户应自行核查事实、引文、原文表述、引用格式及学术规范合规性。
- 因对本项目的不当使用所导致的任何后果，本项目概不负责。
...
它尤其适合为这些写作场景提供前期调研和研究现状整理参考：

- 本科毕业论文
- 硕博论文开题
- 研究计划书
- 学术论文里的 related work 前期梳理
...
- 生成内容仅适合作为研究现状了解、文献筛选和写作准备参考，不应直接用于正式论文提交。
